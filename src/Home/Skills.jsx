        ...
        <div name='skills' className=' text-gray-300' >
            ...
            <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
                ...
                <div className='w-full  grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 text-center py-8'  >
                    ...
                    <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-slate-50'  data-aos="fade-right" data-aos-offset="500"  data-aos-easing="ease-in-sine">
                        <img className='w-20 mx-auto mt-3' src={Photo} alt="" />
                        <p className='my-4 text-black font-bold text-2xl'>HTML</p>
                    </div>

                    <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-slate-50' data-aos="flip-left"data-aos-easing="ease-out-cubic"  data-aos-duration="2000">
                        <img className='w-20 mx-auto mt-3' src={css} alt="" />
                        <p className='my-4 text-black font-bold text-2xl'>CSS</p>
                    </div>

                    <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-slate-50' data-aos="flip-right" data-aos-easing="ease-out-cubic"  data-aos-duration="2000">
